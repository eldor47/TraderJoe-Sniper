...
const targetContract = '0x48496e4A6794Da91FE3575130DAD446a9E23A4d9'
...
//const provider = new ethers.WebSocketProvider(avaxRPC);
const providerJSON = new ethers.JsonRpcProvider(avaxRPCJSON);
const contract = new ethers.Contract(traderJoeContract, CONTRACT_ABI, providerJSON);
...
//         // Fetch transaction details using transaction hash from the event
//         const tx = await providerJSON.getTransaction(e.transactionHash);
